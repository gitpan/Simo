...
Simo is more useful than L<Class::Accessor>.

Simo is more simple than L<Moose> or L<Mouse>.
...
=item 1. Can create accessors very simple way.

=item 2. new method is prepared.

=item 3. Can arrange accessor.( defalt value, constarant value or etc )

=item 4. Can catch error object and get many information of error.

=back

=head1 1. Install of Simo

=head2 1-1. Install of Simo
...
=head2 1-2. Relative module of Simo

Simo have some relative module.

=over 4

=item 1. Simo::Error - create error object to get many information of error

=item 2. Simo::Util - provide useful functions to manipulate of object

=item 3. Simo::Constrain - constrain value when value is set through accessor

=back

=head1 2. Class creating

=head2 2-1. Class creating and definition of accessor
